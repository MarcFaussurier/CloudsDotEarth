...
// Images
const elliot = require("../images/avatar/small/elliot.jpg");
const helen = require("../images/avatar/small/helen.jpg");
const wireframe = require("../images/wireframe/image.png");
const jenny = require("../images/avatar/small/jenny.jpg");
const joe = require("../images/avatar/small/joe.jpg");
const justen = require("../images/avatar/small/justen.jpg");
const matthew = require("../images/avatar/large/matthew.png");
const shortpara = require("../images/wireframe/short-paragraph.png");
